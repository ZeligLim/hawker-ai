...
## Next Task
Owner MVP baseline is complete; replace local persistence with Supabase-backed merchant data when the owner schema and merchant authorization are defined.
