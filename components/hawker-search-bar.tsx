...
export function HawkerSearchBar({
 ...
 const content = (
 <div className="relative flex items-center h-11 w-full rounded-full bg-white/95 backdrop-blur-xl shadow-xs ">
 ...
 className="p-1.5 rounded-full text-[#8e8e93] hover:text-[#1d1d1f] "
 >
