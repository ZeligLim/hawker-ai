...
export function MonetizationSettingsCard({
 ...
 className={`flex flex-col items-center justify-center rounded-[16px] p-3 text-xs font-semibold ${
 feeMode === 'percentage'
 ...
 className={`rounded-[16px] p-3 text-left ${
 feePayer === 'CUSTOMER'
 ? '] bg-[#111827] text-white shadow-sm'
 : ' bg-[#f5f5f7] text-[#1d1d1f] hover:bg-black/5'
 }`}
 ...
 <div className="rounded-[18px] bg-[#f9fafb] p-3.5">
 ...
 <div className="flex justify-between pt-1 font-semibold text-[#1d1d1f]">
 ...
 disabled={saving}
 className="inline-flex items-center gap-2 rounded-full bg-[#111827] px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-black disabled:opacity-70 "
 >
