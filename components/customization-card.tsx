...
export function CustomizationCard({
 ...
 type="button"
 onClick={onCancel}
 className="flex h-8 w-8 items-center justify-center rounded-full text-base text-[#6e6e73] hover:bg-neutral-100 hover:text-black "
 ...
 className="absolute inset-0 h-5 w-full cursor-pointer appearance-none rounded-full bg-transparent accent-black [&::-moz-range-thumb]:h-7 [&::-moz-range-thumb]:w-7 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]: [&::-moz-range-thumb]:bg-black [&::-moz-range-thumb]:shadow-[0_2px_8px_rgba(0,0,0,0.3)] [&::-webkit-slider-thumb]:h-7 [&::-webkit-slider-thumb]:w-7 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-black [&::-webkit-slider-thumb]:shadow-[0_2px_8px_rgba(0,0,0,0.3)]"
 ...
 className={`flex h-11 w-full items-center justify-between rounded-xl px-4 text-left text-xs font-semibold ${
 ...
 className="mt-6 flex h-11 w-full items-center justify-center rounded-full bg-black hover:bg-neutral-800 px-5 text-sm font-semibold text-white disabled:opacity-40 shadow-xs"
 >
