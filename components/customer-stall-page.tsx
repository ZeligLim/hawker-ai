...
function CustomerStallContent() {
 ...
 className="text-xs font-semibold text-[#86868b] hover:text-[#e03e3e] px-2"
 >
 Clear
 </button>
 </div>
 ...
 {/* Filter Chips (Standard h-11 Apple touch target, pure white inactive, pure black active, 0 ) */}
 <div className="mb-5 flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
 <button
 type="button"
 onClick={() => setFilterMode('all')}
 className={`h-11 px-5 rounded-full text-xs font-semibold shrink-0 ${
 filterMode === 'all'
 ...
 <div className="rounded-[22px] bg-white p-8 text-center text-xs sm:text-sm text-[#86868b] shadow-xs">
 ...
 <div className="min-w-0">
 <p className="text-base font-bold text-[#1d1d1f] truncate group-hover:text-blue-600 ">
 {stall.name}
 </p>
 ...
 <Link
 href="/orders"
 className="flex h-11 items-center justify-between rounded-full bg-black px-5 text-white shadow-lg hover:bg-neutral-800 "
 >
