...
export function FocusedStallBanner({
 ...
 return (
 <div className="mt-4 rounded-[24px] bg-[#111827] text-white p-5 sm:p-6 shadow-sm ">
 ...
 type="button"
 onClick={onClear}
 className="inline-flex items-center gap-1.5 rounded-full bg-white/10 hover:bg-white/20 px-3.5 py-1.5 text-xs font-semibold text-white self-start sm:self-auto cursor-pointer"
 >
 ...
 <div className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 ">
