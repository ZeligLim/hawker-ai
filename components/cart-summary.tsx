...
export function CartSummary({
  ...
  if (items.length === 0) {
    return (
      <aside className="rounded-[30px] border border-[#e5e7eb] bg-white p-5 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#6e6e73]">Your order</p>
  ...
  return (
    <aside className="rounded-[30px] border border-[#e5e7eb] bg-white p-5 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
      ...
      <div className="mt-4 space-y-5">
        {Object.values(groupedItems).map((group) => (
          <div key={group.label} className="rounded-[22px] bg-[#f7f7f7] p-3">
            <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#6e6e73]">{group.label}</p>
      ...
      <div className="mt-5 space-y-2 border-t border-[#e5e7eb] pt-4 text-sm text-[#3c3c43]">
