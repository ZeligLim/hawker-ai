        ...
        <header className="sticky top-0 z-20 border-b border-black/5 bg-white/95 px-3 sm:px-4 py-2.5 backdrop-blur-md">
          <div className="mx-auto flex max-w-[960px] items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0">
              <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-blue-600 text-white shadow-sm shrink-0">
                <Building2 className="h-4 w-4" />
              </span>
              <div className="min-w-0 truncate">
                <span className="text-xs font-bold uppercase tracking-wider text-blue-600 hidden xs:inline">
                  Hawker Business App
                </span>
                <span className="text-xs font-bold uppercase tracking-wider text-blue-600 xs:hidden">
                  Venue
                </span>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-2 sm:px-2.5 py-0.5 text-xs font-semibold text-blue-700 border border-blue-200">
                <span className="hidden xs:inline">Shop </span>Owner
              </span>
            </div>
          </div>
        </header>
