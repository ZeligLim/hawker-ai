      ...
      <main className="min-h-screen bg-white px-4 pb-28 pt-8 text-black">
        <div className="mx-auto max-w-[480px]">
          <div className="rounded-3xl bg-neutral-50 p-6 shadow-sm">
            ...
            <Link
              href="/profile"
              className="mt-4 inline-flex h-11 items-center justify-center rounded-full bg-black px-6 text-xs font-semibold text-white shadow-sm hover:bg-neutral-800 transition-colors"
            >
              Back to profile
            </Link>
          </div>
