        ...
        <div className="mx-auto w-full max-w-md sm:max-w-xl md:max-w-2xl">
          <section className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <Link
              ...
              className="mt-6 inline-flex h-11 w-full items-center justify-center rounded-full bg-black px-5 text-sm font-semibold text-white shadow-xs hover:bg-neutral-800 transition-colors"
            >
              Sign in
            </Link>
          </section>
                ...
                <div role="dialog" aria-modal="true" aria-labelledby="sign-out-title" className="w-full max-w-[360px] rounded-3xl bg-white p-6 shadow-2xl">
                  ...
                  <div className="mt-5 flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 h-11 rounded-full bg-black text-sm font-semibold text-white hover:bg-neutral-800 transition-colors"
                    >
                      Sign out
                    </button>
                  </div>
