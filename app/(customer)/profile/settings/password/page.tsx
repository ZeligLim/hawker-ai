...
export default function ChangePasswordPage() {
 ...
 Current password
 <input type={showPasswords ? 'text' : 'password'} value={currentPassword} onChange={(event) => setCurrentPassword(event.target.value)} autoComplete="current-password" required className="mt-2 w-full rounded-[14px] bg-[#f5f5f7] px-3 py-3 text-sm outline-none focus: focus:]" />
 </label>
 <label className="mt-4 block text-sm font-medium">
 New password
 <input type={showPasswords ? 'text' : 'password'} value={newPassword} onChange={(event) => setNewPassword(event.target.value)} autoComplete="new-password" required className="mt-2 w-full rounded-[14px] bg-[#f5f5f7] px-3 py-3 text-sm outline-none focus: focus:]" />
 </label>
 <label className="mt-4 block text-sm font-medium">
 Confirm new password
 <input type={showPasswords ? 'text' : 'password'} value={confirmPassword} onChange={(event) => setConfirmPassword(event.target.value)} autoComplete="new-password" required className="mt-2 w-full rounded-[14px] bg-[#f5f5f7] px-3 py-3 text-sm outline-none focus: focus:]" />
 </label>
 ...
 {isSaving ? <LoaderCircle className="h-4 w-4 " /> : 'Save password'}
 </button>
 </form>
 </section>
 </div>
