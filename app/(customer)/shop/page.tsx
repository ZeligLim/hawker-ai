...
export default async function ShopPage() {
 ...
 <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[14px] bg-white text-sm font-semibold text-[#1d1d1f] shadow-[0_6px_16px_rgba(15,23,42,0.04)] ]">
 {shop.name
 .split(' ')
 .slice(0, 2)
 .map((part) => part[0])
