...
export default function AdminProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="rounded-3xl bg-white p-6 shadow-sm border border-black/[0.04]">
      ...
      <div className="rounded-3xl bg-white p-2 shadow-sm border border-black/[0.04]">
        <button
          type="button"
          onClick={() => setIsSignOutDialogOpen(true)}
          className="w-full flex items-center justify-between p-4 rounded-2xl text-left hover:bg-red-50 text-red-600 transition"
        >
