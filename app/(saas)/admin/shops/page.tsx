              ...
              >
                ...
                <div className="pt-4 border-t border-black/[0.06] flex items-center gap-2">
                  <Link
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-xl bg-white px-3 py-2 text-xs font-semibold text-[#1d1d1f] hover:bg-black/[0.03] transition border border-black/10 shadow-xs"
                  >
                    <span>Details</span>
                  ...
                  <Link
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-xl bg-[#1d1d1f] px-3 py-2 text-xs font-semibold text-white hover:bg-black transition shadow-xs"
                  >
