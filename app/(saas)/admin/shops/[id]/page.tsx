...
export default function AdminShopDetailPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#6e6e73] hover:text-[#1d1d1f] "
 >
 <ArrowLeft className="w-3.5 h-3.5" /> Back to Venues
 </Link>
 <div className="rounded-3xl bg-red-50 p-8 text-center text-red-700 shadow-xs">
 ...
 <Link
 href={'/admin/shops' as any}
 className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#6e6e73] hover:text-[#1d1d1f] mb-2"
 >
 <ArrowLeft className="w-3.5 h-3.5" /> Back to Venues
 </Link>
 ...
 <div className="flex items-center gap-2 .06] pb-4">
