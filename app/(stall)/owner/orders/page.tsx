...
export default function OwnerOrdersPage() {
 ...
 className={`inline-flex h-9 items-center justify-center rounded-[16px] px-4 text-xs font-bold capitalize ${
 ...
 <article
 key={order.backendId}
 className="flex flex-col justify-between rounded-[26px] bg-white p-5 shadow-[0_14px_30px_rgba(15,23,42,0.04)] .04]"
 >
 {/* Ticket Header: Table & Time */}
 <div className="flex items-start justify-between gap-3 .05] pb-3.5">
 <div>
 ...
 className="flex h-7 w-7 items-center justify-center rounded-lg bg-rose-50 text-rose-700 hover:bg-rose-100 disabled:opacity-50 shrink-0 shadow-xs"
 >
 {isRefundingThis ? (
 ...
 <div className="mt-4 pt-3.5 .06] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
 ...
 className="flex h-11 w-full sm:w-auto px-8 items-center justify-center gap-2 rounded-xl bg-black text-sm font-semibold text-white shadow-xs hover:bg-neutral-800 shrink-0"
 >
 ...
 >
 <RefreshCw className={`w-6 h-6 ${loading ? ' text-amber-600' : ''}`} />
 </button>
 </main>
 );
}
