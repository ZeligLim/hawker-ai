      ...
      <div className="mx-auto max-w-[960px]">
        <header className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-semibold tracking-[-0.06em]">Analytics</h1>
            <p className="mt-2 text-sm text-[#6e6e73]">Compare performance across all your booths.</p>
          </div>
        </header>

        <ShopOwnerNav active="analytics" />

        <section className="rounded-[26px] bg-white p-5 shadow-[0_12px_26px_rgba(15,23,42,0.04)]">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            ...
            <div className="rounded-[20px] bg-[#f5f5f7] p-4">
              <p className="text-xs uppercase tracking-[0.12em] text-[#6e6e73]">Total orders</p>
