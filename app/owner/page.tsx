    ...
    <main className="min-h-screen bg-[#f5f5f7] px-4 pb-8 pt-5 text-[#1d1d1f]">
      <div className="mx-auto max-w-[960px]">
        <header className="flex items-center justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#6e6e73]">Hawker owner</p>
            <h1 className="mt-1 text-3xl font-semibold tracking-[-0.06em]">Good evening{profile?.displayName ? `, ${profile.displayName}` : ''}</h1>
          </div>
          <Link href="/profile" className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white shadow-sm" aria-label="Back to customer profile">
