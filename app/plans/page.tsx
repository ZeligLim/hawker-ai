  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f] antialiased selection:bg-[#0071e3] selection:text-white">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-[#1d1d1f] text-white rounded-[36px] p-8 sm:p-12 shadow-2xl relative overflow-hidden border border-white/10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#0071e3]/20 rounded-full blur-3xl pointer-events-none" />

          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8 pb-8 border-b border-white/10">
            <div>
          ...
          <div className="relative z-10 mt-10 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {includedFeatures.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white p-6 sm:p-7 rounded-[28px] border border-black/[0.06] shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-[32px] border border-black/[0.08] shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-black/[0.06] text-xs sm:text-sm">
            {comparisonRows.map((row, idx) => (
              <div
                key={idx}
                className={`grid grid-cols-[1.2fr_1fr_1fr] p-4 sm:p-5 items-center transition-colors ${
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="bg-white p-6 rounded-2xl border border-black/[0.06] shadow-sm space-y-2"
            >
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 text-center">
        <div className="bg-[#1d1d1f] text-white rounded-[32px] p-8 sm:p-14 shadow-xl relative overflow-hidden">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/"
              className="w-full sm:w-auto px-6 py-3.5 rounded-full text-sm font-semibold border border-white/20 hover:bg-white/10 text-white transition-all"
            >
              Return to Homepage
            </Link>
          </div>
